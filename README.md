...
The first thing you need to know is what each of the parts of a computer are so you can purchase them. Here is a list of what you will need: (https://github.com/leeoffir/CustomComputerTutorial/blob/master/PCPARTPICKER.png)
